  ...
  return (
    ...
    >
      ...
      <a href="/pics/11.jpg" data-fancybox="gallery" className="sm:hover:scale-105 ease-out duration-300" data-caption="Another stunning image shot on the rocks of Gran Canaria. Those were the days...">
        ...
        <a href="/pics/7.jpg" data-fancybox="gallery" className="sm:hover:scale-105 ease-out duration-300" data-caption="There's always time to appreciate nature. Don't let Joyce's silly position distract you from the STUNNING red flower!">
          <Image src="/pics/7.jpg" width={500} height={500} alt="" />
        </a>
        <a href="/pics/1.jpg" data-fancybox="gallery" className="sm:hover:scale-105 ease-out duration-300" data-caption="Behold, the picture that caught us all off guard, only to reveal its astonishing cuteness! This little gem has been showered with kisses—so much so that my 'friend' mustered about 20 smooches, setting a new record in the realm of adorable photo affection.">
          <Image src="/pics/1.jpg" width={500} height={500} alt="" />
        </a>
        <a href="/pics/2.jpg" data-fancybox="gallery" className="sm:hover:scale-105 ease-out duration-300" data-caption="Enter the world of Joyce's food affection – a realm where she engages in impromptu staring contests with her culinary delights. Brace yourselves, for these showdowns can last up to an hour!">
          <Image src="/pics/2.jpg" width={500} height={500} alt="" />
        </a>
        <a href="/pics/3.jpg" data-fancybox="gallery" className="sm:hover:scale-105 ease-out duration-300" data-caption="When it comes to capturing you at your absolute finest angle, we can always count on my impeccable photography skills.">
          <Image src="/pics/3.jpg" width={500} height={500} alt="" />
        </a>
        <a href="/pics/4.jpg" data-fancybox="gallery" className="sm:hover:scale-105 ease-out duration-300" data-caption="Joyce doing her morning ritual">
          <Image src="/pics/4.jpg" width={500} height={500} alt="" />
        </a>
        <a href="/pics/5.jpg" data-fancybox="gallery" className="sm:hover:scale-105 ease-out duration-300" data-caption="Joyce can be a real bad girl!">
          <Image src="/pics/5.jpg" width={500} height={500} alt="" />
        </a>
        <a href="/pics/6.jpg" data-fancybox="gallery" className="sm:hover:scale-105 ease-out duration-300" data-caption="Joyce showing off her balancing skills. Quite impressive">
          <Image src="/pics/6.jpg" width={500} height={500} alt="" />
        </a>
        <a href="/pics/8.jpg" data-fancybox="gallery" className="sm:hover:scale-105 ease-out duration-300" data-caption="Ahh all the Nice memories...">
        ...
        <a href="/pics/10.jpg" data-fancybox="gallery" className="sm:hover:scale-105 ease-out duration-300" data-caption="That's right everybody, Joyce is not afraid to get adventurous!">
          <Image src="/pics/10.jpg" width={500} height={500} alt="" />
        </a>
        <a href="/pics/12.jpg" data-fancybox="gallery" className="sm:hover:scale-105 ease-out duration-300" data-caption="Finally, let's not forget the most amazing beer ever, right in the heart of Amsterdam!">
