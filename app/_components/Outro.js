...
const Outro = () => {
  return (
    ...
    <h1 className="text-[40px] font-dynapuff font-bold text-center w-full mb-10 z-10">
      ...
      It's a bit sad that I can't be there with you in person. But let's not dwell on the distance – instead, let's focus on the great times we've shared and the even better times ahead. Here's to your birthday this year and to celebrating it together next year 🥂
        </p>
    </div>
  );
};
